...
public class ObjectLists {
	 ...
	 *
	 * <P>The class of this objects represent an abstract empty list that is a sublist of any type of list. Thus, {@link #EMPTY_LIST} may be assigned to a variable of any (sorted) type-specific list. */
