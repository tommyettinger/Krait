...
public interface ObjectList<K> extends List<K>, Comparable<List<? extends K>>, ObjectCollection<K> {
	 ...
	 *
	 * Note that this specification strengthens the one given in {@link List#iterator()}. It would not be normally necessary, but {@link Iterable#iterator()} is bizarrely re-specified in
	 * {@link List}.
	 *
