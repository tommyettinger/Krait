 ...
 *
 * <P>To create a type-specific iterator you need both a method returning the next element as primitive type and a method returning the next element as an object. However, if you inherit from this
 * class you need just one (anyone).
 *
