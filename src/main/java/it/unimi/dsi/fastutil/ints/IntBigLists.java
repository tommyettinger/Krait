...
public class IntBigLists {
	 ...
	 *
	 * <P>This class may be useful to implement your own in case you subclass a type-specific list. */
	 ...
	 *
	 * <P>The class of this objects represent an abstract empty list that is a sublist of any type of list. Thus, {@link #EMPTY_BIG_LIST} may be assigned to a variable of any (sorted) type-specific
	 * list. */
	 ...
	 *
	 * <P>This class may be useful to implement your own in case you subclass a type-specific big list. */
