...
public interface IntBidirectionalIterator extends IntIterator, ObjectBidirectionalIterator<Integer> {
	 ...
	 *
	 * <P>The effect of this call is exactly the same as that of calling {@link #previous()} for <code>n</code> times (possibly stopping if {@link #hasPrevious()} becomes false).
	 *
