 ...
 *
 * <P>Instances of this class represent a priority queue using a backing array&mdash;all operations are performed directly on the array. The array is enlarged as needed, but it is never shrunk. Use
 * the {@link #trim()} method to reduce its size, if necessary.
 *
 * <P>This implementation is extremely inefficient, but it is difficult to beat when the size of the queue is very small. */
