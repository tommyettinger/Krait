...
public class IntIterators {
	 ...
	 *
	 * <P>This class may be useful to implement your own in case you subclass a type-specific iterator. */
	 ...
	 *
	 * <P>The class of this objects represent an abstract empty iterator that can iterate as a type-specific (list) iterator. */
	 ...
	 *
	 * <P>The type-specific list iterator returned by this method will iterate <code>length</code> times, returning consecutive elements of the given array starting from the one with index
	 * <code>offset</code>.
	 *
	 ...
	 *
	 * <P>The type-specific list iterator returned by this method will return all elements of the given array.
	 *
	 * @param array an array to wrap into a type-specific list iterator.
	 ...
	 *
	 * <P>This method iterates over the given type-specific iterator and returns an array containing the elements returned by the iterator. At most <code>max</code> elements will be returned.
	 *
	 * @param i a type-specific iterator.
	 ...
	 *
	 * <P>This method iterates over the given type-specific iterator and returns an array containing the elements returned by the iterator.
	 *
	 * @param i a type-specific iterator.
	 ...
	 *
	 * <P>This method iterates over the given type-specific iterator and stores the elements returned, up to a maximum of <code>max</code>, in the given type-specific collection. The number of
	 * actually unwrapped elements is returned (it may be less than <code>max</code> if the iterator emits less than <code>max</code> elements).
	 *
	 * @param i a type-specific iterator.
	 ...
	 *
	 * <P>This method iterates over the given type-specific iterator and stores the elements returned in the given type-specific collection. The returned count on the number unwrapped elements is a
	 ...
	 *
	 * <P>This method iterates over the given type-specific iterator and adds the returned elements to the given collection (up to <code>max</code>).
	 *
	 * @param i a type-specific iterator.
	 ...
	 *
	 * <P>This method iterates over the given type-specific iterator and adds the returned elements to the given collection.
	 *
	 * @param i a type-specific iterator.
	 * @param s a type-specific collection.
	 * @return the number of elements poured. Note that this is the number of elements returned by the iterator, which is not necessarily the number of elements that have been added to the collection
	 ...
	 *
	 * <P>This method iterates over the given type-specific iterator and returns a type-specific list containing the returned elements (up to <code>max</code>). Iteration on the returned list is
	 ...
	 *
	 * <P>This method iterates over the given type-specific iterator and returns a list containing the returned elements. Iteration on the returned list is guaranteed to produce the elements in the
	 ...
	 *
	 * <P>This method wraps a standard iterator into a type-specific one which will handle the type conversions for you. Of course, any attempt to wrap an iterator returning the instances of the wrong
	 * class will generate a {@link ClassCastException}. The returned iterator is backed by <code>i</code>: changes to one of the iterators will affect the other, too.
	 *
	 * <P>If <code>i</code> is already type-specific, it will returned and no new object will be generated.
	 *
	 * @param i an iterator.
	 ...
	 *
	 * <P>This method wraps a standard list iterator into a type-specific one which will handle the type conversions for you. Of course, any attempt to wrap an iterator returning the instances of the
	 * wrong class will generate a {@link ClassCastException}. The returned iterator is backed by <code>i</code>: changes to one of the iterators will affect the other, too.
	 *
	 * <P>If <code>i</code> is already type-specific, it will returned and no new object will be generated.
	 *
	 ...
	 *
	 * <P>The type-specific list iterator returned by this method will return the elements <code>from</code>, <code>from+1</code>,&hellip;, <code>to-1</code>.
	 *
	 ...
	 *
	 * <P>This method returns an iterator that will enumerate in order the elements returned by all iterators contained in the given array.
	 *
	 ...
	 *
	 * <P>This method returns an iterator that will enumerate in order the elements returned by <code>a[ offset ]</code>, then those returned by <code>a[ offset + 1 ]</code>, and so on up to <code>a[
	 * offset + length - 1 ]</code>.
	 *
	 * @param a an array of iterators.
