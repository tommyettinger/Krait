 ...
 *
 * <P>Instances of this class represent a FIFO queue using a backing array in a circular way. The array is enlarged and shrunk as needed. You can use the {@link #trim()} method to reduce its memory
 * usage, if necessary.
 *
...
public class IntArrayFIFOQueue extends AbstractIntPriorityQueue implements Serializable {
	...
	/** The end position in {@link #array}. It is always strictly smaller than {@link #length}. Might be actually smaller than {@link #start} because {@link #array} is used cyclically. */
