 ...
 *
 * <P>An indirect heap is an extension of a semi-indirect heap using also an <em>inversion array</em> of the same length as the reference array, satisfying the relation <code>heap[inv[i]]==i</code>
 * when <code>inv[i]&gt;=0</code>, and <code>inv[heap[i]]==i</code> for all elements in the heap. */
