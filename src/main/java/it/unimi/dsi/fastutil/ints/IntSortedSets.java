...
public class IntSortedSets {
	 ...
	 *
	 * <P>This class may be useful to implement your own in case you subclass a type-specific sorted set. */
	 ...
	 *
	 * <P>The class of this objects represent an abstract empty set that is a subset of a (sorted) type-specific set. */
