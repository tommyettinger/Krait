 ...
 *
 * <P>Additionally, this interface strengthens {@link #iterator()}, {@link #comparator()} (for primitive types), {@link SortedSet#subSet(Object, Object)}, {@link SortedSet#headSet(Object)} and
 * {@link SortedSet#tailSet(Object)}.
 *
 * @see SortedSet */
public interface IntSortedSet extends IntSet, SortedSet<Integer> {
	/** Returns a type-specific {@link it.unimi.dsi.fastutil.BidirectionalIterator} on the elements in this set, starting from a given element of the domain (optional operation).
	 *
	 * <P>This method returns a type-specific bidirectional iterator with given starting point. The starting point is any element comparable to the elements of this set (even if it does not actually
	 ...
	 * {@link it.unimi.dsi.fastutil.BidirectionalIterator#hasNext() hasNext()} will return <code>false</code>). The previous element of the returned iterator is the greatest element of the set that is
	 * smaller than or equal to the starting point (if there are no elements smaller than or equal to the starting point, {@link it.unimi.dsi.fastutil.BidirectionalIterator#hasPrevious()
	 * hasPrevious()} will return <code>false</code>).
	 * 
	 * <P>Note that passing the last element of the set as starting point and calling {@link it.unimi.dsi.fastutil.BidirectionalIterator#previous() previous()} you can traverse the entire set in
	 * reverse order.
	 *
	 ...
	 *
	 * <P>The iterator returned by the {@link #iterator()} method and by this method are identical; however, using this method you can save a type casting.
	 *
	 ...
	 *
	 * <P>This method returns a parameterised bidirectional iterator. The iterator can be moreover safely cast to a type-specific iterator.
	 *
	 * Note that this specification strengthens the one given in the corresponding type-specific {@link Collection}.
	 *
