...
public interface IntSet extends IntCollection, Set<Integer> {
	 ...
	 *
	 * <p>Note that the corresponding method of the type-specific collection is <code>rem()</code>. This unfortunate situation is caused by the clash with the similarly named index-based method in the
